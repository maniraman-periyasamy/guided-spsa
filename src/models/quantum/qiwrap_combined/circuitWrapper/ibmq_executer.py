...
class ibmq_executer(base_executer):
    ...
    def __init__(
            ...
            num_parallel_process: Optional[int] = None, shots: Optional[int] = None,  grad_reset: Optional[int] = None,
        ...
        super(ibmq_executer, self).__init__(
            ...
            num_parallel_process=num_parallel_process, shots=shots, grad_decay=grad_decay, grad_reset=grad_reset, ibmq_executer=True,
    ...
    def set_executer(self, session=None, options=None, noise_model=None, coupling_map=None, basis_gates=None):
        ...
        if options is None:
            Options(optimization_level=3, resilience_level=2, simulator={'noise_model':noise_model, 
